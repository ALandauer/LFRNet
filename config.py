...
config.PSF.n_slices = 61  # z depth
config.PSF.Nnum     = 11
config.n_channels   = 1
...
config.TRAIN.target3d_path  = 'example_data/train/bead/[m30-30]step1um/WF/'
config.TRAIN.lf2d_path      = 'example_data/train/bead/[m30-30]step1um/LF/'
